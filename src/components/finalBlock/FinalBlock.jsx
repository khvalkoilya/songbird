...
const FinalBlock = () => {
  const {
    score, setIsFinished, setScore, setCurrentLevel,
    setReadyToChangeLevel, setDefaultDescriptionOfBird, setTrueNumberOfBird,
  } = useContext(Context);
  const loserBlock = (
    <>
      ...
      <p>
        Вы набрали
        {' '}
        <span className="final-block__bold-text">{score}</span>
        {' '}
        баллов.
      </p>
      <p>
        Из возможных
        {' '}
        <span className="final-block__bold-text">30</span>
        .
      </p>
      <button
        type="button"
